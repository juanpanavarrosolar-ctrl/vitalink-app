    ...
    html: `
      <div style="font-family:sans-serif;max-width:560px;margin:0 auto;color:#111827">
        <div style="background:#0891b2;padding:20px 24px;border-radius:12px 12px 0 0">
          <span style="color:#fff;font-size:20px;font-weight:800">NutriLink</span>
        </div>
        <div style="padding:24px;background:#fff;border:1px solid #e5e7eb;border-top:none;border-radius:0 0 12px 12px">
          <p>Hola, <strong>${patientName}</strong> 👋</p>
          <p>Tu nutricionista <strong>${professionalName}</strong> ha preparado un protocolo de suplementación especialmente para ti:</p>
    ...
    html: `
      <div style="font-family:sans-serif;max-width:560px;margin:0 auto;color:#111827">
        ...
        <div style="padding:24px;background:#fff;border:1px solid #e5e7eb;border-top:none;border-radius:0 0 12px 12px">
          ...
          <p style="font-size:14px;color:#6b7280">Recibirás un email de tu nutricionista con el seguimiento. El despacho se realizará en los próximos días hábiles.</p>
          ${DISCLAIMER}
        </div>
      </div>
    `,
